	...
	<form action="" method="post">
		<table class="form-table">
			<tr>
				...
				<td>
					...
					<p class="description help_block">You need to create an OAuth2 application before you can proceed
						...
						creating your app use <code><?php echo admin_url('admin.php?page=helpscout-integration'); ?></code> as the redirect
						url.</p>
				</td>
			...
			<tr>
				...
				<td>
					<input type="text" class="regular-text" name="helpscout_app_secret" value="<?php echo $app_secret; ?>">
			...
			<tr>
				...
				<td>
					<input type="text" name="mailbox" id="mailbox" value="<?php echo $mailbox_id; ?>" placeholder="" size="40"
					       class="text-input">

					<p class="description help_block">When opening a mailbox within Help Scout, open the mailbox and click Settings in the bottom left corner of the mailbox filters list and click in Edit Mailbox. In the URL of the resulting settings screen, is your mailbox ID. Example, https://secure.helpscout.net/settings/mailbox/<b>123456</b>/</p>
				</td></tr>
			<?php if ( ! empty( $app_id ) &&  ! empty( $app_secret ) ): ?>
				<tr>
					<td></td>
					<td><a href="https://secure.helpscout.net/authentication/authorizeClientApplication?client_id=<?php echo $app_id; ?>&state=<?php echo
						$app_secret;
						?>">Get
							authorize</a></td>
				</tr>
